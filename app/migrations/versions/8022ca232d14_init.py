...
Revision ID: 8022ca232d14
Revises:
Create Date: 2025-04-16 10:53:15.071711
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["product_uid"],
            ["products.uid"],
            name=op.f("fk_product_property_ints_product_uid_products"),
        ),
        sa.ForeignKeyConstraint(
            ["property_uid"],
            ["properties.uid"],
            name=op.f("fk_product_property_ints_property_uid_properties"),
        ),
        sa.PrimaryKeyConstraint(
            "product_uid", "property_uid", name=op.f("pk_product_property_ints")
        ),
    )
    op.create_table(
        "property_values",
        ...
        sa.ForeignKeyConstraint(
            ["property_uid"],
            ["properties.uid"],
            name=op.f("fk_property_values_property_uid_properties"),
        ),
        sa.PrimaryKeyConstraint("uid", name=op.f("pk_property_values")),
    )
    op.create_index(
        op.f("ix_property_values_uid"), "property_values", ["uid"], unique=False
    )
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["product_uid"],
            ["products.uid"],
            name=op.f("fk_product_property_values_product_uid_products"),
        ),
        sa.ForeignKeyConstraint(
            ["property_uid"],
            ["properties.uid"],
            name=op.f("fk_product_property_values_property_uid_properties"),
        ),
        sa.ForeignKeyConstraint(
            ["value_uid"],
            ["property_values.uid"],
            name=op.f("fk_product_property_values_value_uid_property_values"),
        ),
        sa.PrimaryKeyConstraint(
            "product_uid", "property_uid", name=op.f("pk_product_property_values")
        ),
    )
